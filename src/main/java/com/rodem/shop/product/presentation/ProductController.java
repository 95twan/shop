package com.rodem.shop.product.presentation;

import com.rodem.shop.common.ResponseEntity;
import com.rodem.shop.product.application.ProductService;
import com.rodem.shop.product.application.dto.ProductInfo;
import com.rodem.shop.product.presentation.dto.ProductRequest;
...
public class ProductController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProductInfo> update(@PathVariable("id") UUID id, @RequestBody ProductRequest request) {
