package com.rodem.shop.seller.presentation;

import com.rodem.shop.common.ResponseEntity;
import com.rodem.shop.seller.application.SellerService;
import com.rodem.shop.seller.application.dto.SellerInfo;
import com.rodem.shop.seller.presentation.dto.SellerRequest;
...
public class SellerController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SellerInfo> update(@PathVariable("id") UUID id, @RequestBody SellerRequest request) {
